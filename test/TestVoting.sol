...
contract TestVoting {
    ...
    function testUserCanVoteLocation() public {
        ...
        Assert.equal(returnedId, expectedLocationId, 
        "User was able to vote for the expected location"
        );
    ...
    function testGetVotedLocationAddressByLocationId() public {
        ...
        Assert.equal(location, expectedVotedLocation,
    ...
    function testGetVotedlocationAddressByLocationIdInArray() public {
            ...
            Assert.equal(locations[expectedLocationId],
            expectedVotedLocation,
            "Voted location of the expected location"
            );
    }
